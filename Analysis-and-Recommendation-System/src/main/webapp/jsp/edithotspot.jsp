...
<div class="form-container" >
    ...
    <form action="/updatehotspot" method="post">
        <table>
            <tr>
                <th style="color: white"><label for="name">学校名称:</label></th>
                <td><input type="text" id="name" name="name" required value="${hotspotInfo.name}" readonly></td>
            </tr>
            <tr>
                <th style="color: white"><label for="word">热词:</label></th>
                <td><input type="text" id="word" name="word"  required value="${hotspotInfo.word}" readonly></td>
            </tr>
            <tr>
                <th style="color: white"><label for="heatRatio">出现比例:</label></th>
                <td><input type="text" id="heatRatio" name="heatRatio"  required value="${hotspotInfo.heatRatio}"></td>
            </tr>
        </table>
